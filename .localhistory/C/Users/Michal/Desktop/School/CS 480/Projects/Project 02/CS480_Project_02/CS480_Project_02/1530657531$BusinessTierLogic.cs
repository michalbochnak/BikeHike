...
namespace BusinessTier
{
  public class Business
  {
    ...
    public void RentBikes(List<int> selectedBikes, int cid, decimal expDur)
    {
      ...
      int rid = Convert.ToInt32(dataTier.ExecuteScalarQuery());
    ...
    private void RentBike(int bid, int cid)
    {
