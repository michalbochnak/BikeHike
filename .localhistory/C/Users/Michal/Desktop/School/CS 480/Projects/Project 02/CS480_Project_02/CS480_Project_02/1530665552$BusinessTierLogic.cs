...
namespace BusinessTier
{
  public class Business
  {
    ...
    public string ReturnBikes(int cid)
    {
      try
      {
        ...
        DateTime dt = Convert.ToDateTime(ds_1.Tables["TABLE"].Rows[0]["StartTime"]);
        ...
        string totalPrice = dataTier.ExecuteScalarQuery(string.Format(@"
