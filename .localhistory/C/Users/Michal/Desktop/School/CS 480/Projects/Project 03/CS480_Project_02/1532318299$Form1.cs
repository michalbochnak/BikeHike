...
namespace BikeHike
{
  public partial class Form1 : Form
  {
    ...
    private void RentButton_Click(object sender, EventArgs e)
    {
      ...
      {
        string answer = business.RentBikes(selectedBikes, customers.ElementAt(index).CID,
        ...
        {
          MessageBox.Show("Rental ID: " + answer);
          RentingTextBox.Text = "Yes";
    ...
    private void resetDatabaseButton_Click(object sender, EventArgs e)
    {
      ...
      if (status == true)
      {
        MessageBox.Show("Reset operation succesfull");
        clearWholeUi();
      } 
      else
      {
