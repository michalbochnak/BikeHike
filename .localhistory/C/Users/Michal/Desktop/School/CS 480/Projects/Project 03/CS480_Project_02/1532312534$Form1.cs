...
namespace BikeHike
{
  public partial class Form1 : Form
  {
    ...
    private void RentButton_Click(object sender, EventArgs e)
    {
      ...
      {
        string rid = business.RentBikes(selectedBikes, customers.ElementAt(index).CID,
    ...
    private void ReturnButton_Click(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        double totalPrice = business.ReturnBikes(customers.ElementAt(index).CID);
