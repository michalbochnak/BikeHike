...
namespace BikeHike
{
  public partial class Form1 : Form
  {
    ...
    private void AllCustomersListBox_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      RentingTextBox.Text = (business.GetCustRentStatus(cid) == true) ? "Yes" : "No";
    }
    ...
    private void AllBikesListBox_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      ExpectedReturnTextBox.Text = rented == true ? GetExpectedReturnTime() : "Available now";
    }

    private string GetExpectedReturnTime()
    {
      DateTime dt = business.GetExpectedReturnTime();
      return "time";
    }
    ...
    private void RentButton_Click(object sender, EventArgs e)
    {
      ...
      {
        MessageBox.Show(business.RentBikes(selectedBikes, customers.ElementAt(index).CID, 
