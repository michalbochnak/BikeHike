...
namespace BusinessTier
{
  ...
  public class Business
  {
    ...
    //
    // Calculates the expected return time for the given bike base on the expected 
    ...
    //
    // Calculates the expected return time for the given customer base on the expected 
    // rent duration provided by customer
    //
