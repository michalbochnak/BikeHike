...
VALUES              ((SELECT CID FROM Customers WHERE FirstName = 'Stan'), '1/31/2016');

INSERT INTO OrderDetails  (OID, PID, Quantity, PricePaid)
VALUES                    ((SELECT OID FROM Orders WHERE CID = 2001), (SELECT PID FROM Products WHERE PID = 1001), 10, 9.99);
