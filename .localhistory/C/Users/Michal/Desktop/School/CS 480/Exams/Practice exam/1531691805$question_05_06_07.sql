...
VALUES              ((SELECT CID FROM Customers WHERE FirstName = 'Aga'), '1/30/2016');

INSERT INTO OrderDetails  (OID, PID, Quantity, PricePaid)
VALUES                    ((SELECT OID FROM Orders WHERE OID = 7), (SELECT PID FROM Products WHERE PID = 1001), 10, 9.99);
